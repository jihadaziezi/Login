...
import com.jihad.login.TambahMahasiswaActivity2;
...
public class TambahMahasiswaActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambah_mahasiswa2);
            ...
            public void onClick(View view) {
                ...
                ahc.get(url, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, byte[] responseBody) {
                        ...
                        new AlertDialog.Builder(TambahMahasiswaActivity2.this)
                                .setTitle("Berhasil")
